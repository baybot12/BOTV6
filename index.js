...
//JANGAN LUPA SUBSCRIBE abdulaziz albaihaqi
...
ban = []
cr = 'ABAY BOT*'
vz = '*Terima Kasih Sudah Daftar Di Abay BOT*'
const vcard = 'BEGIN:VCARD\n' //
            + 'VERSION:3.0\n' //
            + 'FN: ABAY\n' //
            + 'ORG:Creator ABAY BOT;\n' //
...
client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net"]
			const mod = [ownerNumber,"6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net"]
			const adminbotnumber = ["6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net"]
			const frendsowner = ["62895622956417@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net"]
			const premium = ["6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285694347823@s.whatsapp.net","6285281968399@s.whatsapp.net","6288705834498@s.whatsapp.net"]
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam wr.wb${pushname}:)`)
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    client.sendMessage('62895622956417@s.whatsapp.net', options, text, {quoted: mek})
